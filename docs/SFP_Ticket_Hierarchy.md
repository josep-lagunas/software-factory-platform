...
**Labels:** manual-core, ai-agent, agent-layer, pipeline, observability, fix | **Status:** Done (PR #125)
**Context:** aborts surfaced only "not READY"; the structured blocking_ambiguities/missing_inputs/rubric_failed were swallowed.
**Deps:** ticket_pipeline (slice). **References:** SFP-51, SFP-232.

### SFP-237 [AGENT] 🤖 — Align ticket_pipeline model tiers with the orchestrator harness
**Labels:** manual-core, ai-agent, agent-layer, pipeline, config, dogfood | **Status:** Done
...
**Labels:** manual-core, ai-agent, agent-layer, pipeline, contracts, config, dogfood | **Status:** Done
...
**Labels:** manual-core, ai-agent, workspace, pipeline, fix, dogfood | **Status:** Done (PR #132)
...
**Labels:** manual-core, ai-agent, workspace, pipeline, fix, dogfood | **Status:** Done (PR #134)
...
**Labels:** manual-core, ai-agent, workspace, pipeline, fix, dogfood | **Status:** Done (PR #135)
...
**Labels:** manual-core, ai-agent, workspace, pipeline, fix, dogfood, reliability | **Status:** Done (PR #139)
...
**Labels:** platform, ai-agent, orchestrator, dogfood, reliability | **Status:** To Do (candidate, queued by owner)
...
**Deps:** SFP-232/236 (structured gate output), AgentRuntime seam (ID-019). **Soft:** SFP-149 placement.
