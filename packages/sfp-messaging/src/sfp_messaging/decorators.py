...
:class:`~sfp_contracts.commands.models.ExecuteCodingJob`), and return the
...
def command_handler(message_type: type) -> _HandlerDecorator:
    ...
    :class:`~sfp_contracts.commands.models.ExecuteCodingJob`) and returns
...
def event_handler(message_type: type) -> _HandlerDecorator:
    ...
    :class:`~sfp_contracts.events.models.UserInputReceived`). Returns ``func``
